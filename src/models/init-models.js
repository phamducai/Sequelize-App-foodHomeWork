...
const _order_user = require("./order_user");
...
function initModels(sequelize) {
  ...
  const order_user = _order_user(sequelize, DataTypes);
  ...
  order_user.belongsTo(food, { as: "food", foreignKey: "food_id" });
  food.hasMany(order_user, { as: "order_users", foreignKey: "food_id" });
  ...
  order_user.belongsTo(user, { as: "user", foreignKey: "user_id" });
  user.hasMany(order_user, { as: "order_users", foreignKey: "user_id" });
